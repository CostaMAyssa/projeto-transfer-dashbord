    ...
    try {
      ...
      if (!basePrice) {
        ...
        return {
          success: true,
          price: finalPrice,
          pickup_zone: pickupZoneResult.zone_name || undefined,
          dropoff_zone: dropoffZoneResult.zone_name || undefined,
          vehicle_category: vehicleType,
          distance_miles: routeDistance || undefined,
